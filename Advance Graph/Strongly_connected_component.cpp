...
int main()
{
	int n;
	cin >> n;
	vector<int>* edges = new vector<int>[n];  //edges
	vector<int>* edgesT = new vector<int>[n];  //tranpose edges;
	...
	for (int i = 0; i < m; i++) {
		int j, k;
		cin >> j >> k;
		edges[j - 1].push_back(k - 1);   //edges
		edgesT[k - 1].push_back(j - 1);  //tranpose edges;
	}
